  ...
  using cInt = Int32;
    ...
    public IntPoint(IntPoint pt)
    {
      this.X = pt.X; this.Y = pt.Y; this.Z = pt.Z;
        ...
        public static explicit operator UnityEngine.Vector3(IntPoint p)
        {
            return new UnityEngine.Vector3((float)p.X / Multiplier, 0, (float)p.Y / Multiplier);
        }
        public static explicit operator IntPoint(UnityEngine.Vector3 p)
        {
            return new IntPoint(UnityEngine.Mathf.RoundToInt(p.x * Multiplier), UnityEngine.Mathf.RoundToInt(p.z * Multiplier));
        }
        public static explicit operator Poly2Tri.Triangulation.TriangulationPoint(IntPoint p)
        {
            return new Poly2Tri.Triangulation.TriangulationPoint((double)p.X / Multiplier, (double)p.Y / Multiplier);
        }
        public static explicit operator IntPoint(Poly2Tri.Triangulation.TriangulationPoint p)
        {
            return new IntPoint(p.X * Multiplier, p.Y * Multiplier);
        }
        public static explicit operator Poly2Tri.Triangulation.Polygon.PolygonPoint(IntPoint p)
        {
            return new Poly2Tri.Triangulation.Polygon.PolygonPoint((double)p.X / Multiplier, (double)p.Y / Multiplier);
        }
        public static explicit operator IntPoint(Poly2Tri.Triangulation.Polygon.PolygonPoint p)
        {
            return new IntPoint(p.X * Multiplier, p.Y * Multiplier);
        }
